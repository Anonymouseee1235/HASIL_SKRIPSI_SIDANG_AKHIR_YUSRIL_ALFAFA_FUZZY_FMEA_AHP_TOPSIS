...
// TAB SWITCHING FUNCTION (Smooth Navigation)
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            return ' CCi Score: ' + context.parsed.y.toFixed(4);
                        }
                    }
                }
            },
            scales: {
                y: { beginAtZero: true, max: 0.8, grid: { color: '#e2e8f0' } },
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    callbacks: {
                        label: function(context) {
                            return ' Bobot: ' + (context.parsed * 100).toFixed(2) + '%';
                        }
                    }
                }
            }
